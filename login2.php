    ...
    if(mysqli_num_rows($result) === 1){
        ...
        if($sandiTerenkripsi == $inputTerenkripsi){
            ...
            if(isset($_POST['remember'])){
                ...
                if($row['divisi'] == "sales" || $_SESSION['sales']){
                    $_SESSION['divisiSales'];
                    header('location:sales.php');
                    exit;
                }
                elseif($row['divisi'] == "desopr" || $_SESSION['desopr']){
                    $_SESSION['divisiDesopr'] = "desopr";
                    header('location:desopr.php');
                    exit;
                }
                elseif($row['divisi'] == "admwrk" || $_SESSION['admwrk']){
                    $_SESSION['divisiAdminwrk'] = "admwrk";
                    header('location:admin-workshop.php');
                    exit;
                }
                else {
