    ...
    <div class="container-fluid bg-warning py-5">
        ...
        <form action="proses-sales.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Contoh : 300000 (tanpa tanda titik atau Rp)" name="omset">
                <br>
                ...
                <input class="form-control" type="text" placeholder="Contoh : Jl. Pahlawan ..." name="alamatPelanggan">
                <br>
