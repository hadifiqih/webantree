...
?>
                        ...
                        <input class="form-control" type="text" placeholder="Contoh : Stempel Es Madura"
                            name="keywordStamp" value="<?php echo $dataEdit['keyword_stempel']; ?>">
                        <br>
...
?>
                        ...
                        <input class="form-control" type="datetime-local" name="startJob" id="startJob"
                            value="<?= $dataEdit['mulai_kerja']; ?>">
                        <br>

                        <label for="finishJob">Selesai</label>
                        <input class="form-control" type="datetime-local" name="finishJob" id="finishJob"
                            value="<?= $dataEdit['selesai_kerja']; ?>">
                        <br>

                        <div class="radio">
                            <p>Tempat Workshop</p>
                            <?php $tw = $dataEdit['tempat_workshop']; ?>
                            <label class="mx-2" for="whereWorkshop"><input class='mx-1' type="radio"
                                    name="whereWorkshop" value="Surabaya"
                                    <?php echo ($tw == 'Surabaya') ? "checked" : "" ?>>Surabaya</label>
                            <label class="mx-2" for="whereWorkshop"><input class='mx-1' type="radio"
                                    name="whereWorkshop" value="Malang"
                                    <?php echo ($tw == 'Malang') ? "checked" : "" ?>>Malang</label>
                            <label class="mx-2" for="whereWorkshop"><input class='mx-1' type="radio"
                                    name="whereWorkshop" value="Kediri"
                                    <?php echo ($tw == 'Kediri') ? "checked" : "" ?>>Kediri</label>
                        </div>
                        <br>
